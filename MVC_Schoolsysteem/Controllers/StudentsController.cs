...
namespace MVC_Schoolsysteem
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Lastname,EnrollmentDate")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Lastname,EnrollmentDate")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
